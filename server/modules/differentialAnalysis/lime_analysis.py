...
class LIME_Analysis:
    ...
    def fit(self):
        """
        Fit the model and initialize the LIME explainer.
        """
    ...
    def explain_samples(self):
        ...
        plt.title(f"Local explanation for class {self.class_names[0]} on an {self.class_names[1]} Sample", x=0.3, fonstsize=25)
        plt2.tight_layout()
